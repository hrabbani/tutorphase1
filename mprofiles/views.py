...
def mentor_connect(request):
    if request.method=='POST':
        ...
        if exist_connection.exists():
            ...
            content = "Dear " + student.first_name + " " + student.last_name + " and " + mentor.first_name + " " + mentor.last_name + ", Welcome to Peninsula Bridge's High School Mentor Program! We are so excited to introduce you two to each other. " + mentor.first_name + ", we ask that you please reach out to " + student.first_name + " within the next two weeks to schedule your first meeting. And " + student.first_name + ", we ask that you please make sure to respond immediately. Here is a suggested agenda to follow for your first meeting: https://docs.google.com/document/d/1IeSDmICouu2yAjdWgW3urVS99de35z7Sa6OfByIkXT8/edit. Please let me know when you plan to meet and I will attend as well if I can. " + student.first_name + ", please find a time when at least one parent/guardian can attend with you for the first few minutes to exchange contact information. This is required only for the first meeting, all subsequent meetings should be only the mentor and the mentee. As a reminder, the minimum requirement to meet with each other is at least once per month. It is important that you both be responsive to each other's communication throughout the year. And " + student.first_name + ", there is so much you can gain from this relationship (ex. networking opportunities, personal support, college and career advice, exposure to different ideas,etc), however, please note that will only happen if you show up to every meeting with eagerness, curiosity, and determination. Have fun! If you have any questions or concerns, please reach out to me at komal@peninsulabridge.org. Best, Komal Goel"
